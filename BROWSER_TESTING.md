...
## Testing Workflow for Polyblocks
...
agent-browser screenshot --full editor.png

# Interact with the canvas
agent-browser find testid "add-block-btn" click
agent-browser snapshot -i
agent-browser screenshot block-added.png
